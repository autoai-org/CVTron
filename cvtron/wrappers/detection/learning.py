...
def train_step(sess, train_op, global_step, train_step_kwargs):
  ...
  if 'should_log' in train_step_kwargs:
    if sess.run(train_step_kwargs['should_log']):
      ...
      if 'logger' in train_step_kwargs:
        log = {
          'global_step': str(np_global_step),
          'loss': str(total_loss)
        }
        train_step_kwargs['logs'].append(log)
        train_step_kwargs['logger'].writeLog(train_step_kwargs['logs'], os.path.join(train_step_kwargs['weblog_dir'], 'log.json'))
